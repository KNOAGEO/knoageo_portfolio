...
<nav id="nav-pc-search">
    <h1 class="title-2pc">検索</h1>
    <hr class="light-mainbar" />
    <div class="search-box">
      <input type="text" id="search-query" placeholder="検索ワードを入力してください...">
      <div class="search-icon">
      <img src="<?php echo get_template_directory_uri(); ?>/image/検索アイコン.png" alt="検索" onclick="performSearch()">
        </div>
        <div class="close-1">
...
<nav id="nav-pc">
 ...
 <div class="category">作例ライブラリ<a href="<?php echo home_url(); ?>/library" onclick="document.getElementById('nav-sp').style.display = 'none'"></div>
